...
import { AnalysisResult, TriageLevel, UserProfile, Symptom } from '../../shared/types';
import { HeartIcon, ShieldCheckIcon, ExclamationTriangleIcon, ExclamationCircleIcon } from '../../shared/Icons';
...
const PredictionResults: React.FC<PredictionResultsProps> = ({ analysisResult, userProfile, symptoms, onGeneratePDF, onNext, onReset, isLoading }) => {
        ...
        <div>
            {userProfile && (
                <div className="mb-6 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                    <h2 className="text-xl font-bold text-slate-100 mb-2">Hello, {userProfile.name}!</h2>
                    <p className="text-slate-400">Here's your health assessment based on the symptoms you've provided.</p>
                </div>
            )}
            ...
            <div className="mt-6 text-center">
                <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-brand-teal-600 hover:bg-brand-teal-700 text-white font-medium rounded-lg transition-colors"
                >
