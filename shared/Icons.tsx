...
export const StethoscopeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4.5 10.5c-3.3 0-6 2.7-6 6v3h6v-3c0-3.3-2.7-6-6-6zM4.5 21v-3" />
        <path d="M12 11v10" />
        <path d="M9 11h6" />
        <path d="M19.5 10.5c3.3 0 6 2.7 6 6v3h-6v-3c0-3.3 2.7-6 6-6zM19.5 21v-3" />
...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.534c-.454.065-.904.13-1.354.195-1.061.143-2.122.215-3.182.215-1.06 0-2.121-.072-3.182-.215a48.421 48.421 0 01-1.354-.195l-3.722-.534c-1.133-.093-1.98-1.057-1.98-2.193V10.608c0-.97.616-1.813 1.5-2.097L6.75 8.25m10.5 0L17.25 7.5m-10.5 0L6.75 7.5m10.5 0v3.75m-10.5-3.75v3.75m10.5 0v3.75m-10.5-3.75v3.75M6.75 12h10.5" />
    </svg>
);
...
export const WaterDropIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s9.75 11.25 9.75 11.25 9.75-5.865 9.75-11.25S17.385 2.25 12 2.25zm0 14.5a4.75 4.75 0 004.75-4.75c0-2.34-1.6-4.59-4.75-7.5-3.15 2.91-4.75 5.16-4.75 7.5A4.75 4.75 0 0012 16.75z" />
    </svg>
);
...
export const BrainIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4-2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128a2.25 2.25 0 012.248-2.245 4.5 4.5 0 007.238-3.328c0-.177-.02-.35-.057-.518A2.25 2.25 0 0019.5 8.572a2.25 2.25 0 00-2.245 2.245c0 .399.078.78.22 1.128a2.25 2.25 0 01-2.248 2.245 4.5 4.5 0 00-7.238 3.328c0 .177.02.35.057.518a2.25 2.25 0 002.245 2.245c.626 0 1.158-.233 1.565-.615a2.25 2.25 0 012.4 2.245 4.5 4.5 0 00-8.4 2.245c0 .399.078.78.22 1.128a2.25 2.25 0 00-2.248 2.245 4.5 4.5 0 009.232-1.405" />
    </svg>
);
...
export const MapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m0 0v2.25m0-2.25h1.5m-1.5 0h-1.5m-1.5-7.5V15m0 0v2.25m0-2.25h1.5m-1.5 0h-1.5m6-6.75V15m0 0v2.25m0-2.25h1.5m-1.5 0h-1.5m-1.5-7.5V15m0 0v2.25m0-2.25h1.5m-1.5 0h-1.5M15 21H9a2.25 2.25 0 01-2.25-2.25V5.25A2.25 2.25 0 019 3h6a2.25 2.25 0 012.25 2.25v13.5A2.25 2.25 0 0115 21z" />
    </svg>
);
...
export const DirectionsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-5.25-4.25-9.5-9.5-9.5S.5 6.75.5 12s4.25 9.5 9.5 9.5 9.5-4.25 9.5-9.5zM12 6.25v6.5m0 0l-3.25-3.25M12 12.75l3.25-3.25" />
    </svg>
);